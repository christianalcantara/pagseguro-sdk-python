...
from pagbank.config.config import Config
from pagbank.config.request_options import RequestOptions


class PBBase:
    """All pagbanck.resources extends this one to call the REST services

    Args:
        request_options (pagbank.config.request_options, optional):
